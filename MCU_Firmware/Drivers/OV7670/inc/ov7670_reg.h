 ...
 * ov7676_reg.h
 *
 *  Created on: 3 ott 2019
 *      Author: Alessandro
 */

#ifndef OV7676_INC_OV7670_REG_H_
#define OV7676_INC_OV7670_REG_H_
...
const uint8_t OV7670_reg[][2] = {
  /* Color mode related */
  {0x12, 0x16},   // QVGA, RGB prima era 14
  {0x8C, 0x00},   // RGB444 Disable, useless??
...
//  {0x6B, 0x4a}, //PLL  x4
  ...
  /* others */
  {0x1E, 0x00}, //NO mirror flip
  //{0x42, 0x48}, // 1/2 window
  //{0x0D, 0x10}, // 1/2 window
  {REG_BATT, REG_BATT},
};


#endif /* OV7676_INC_OV7670_REG_H_ */
