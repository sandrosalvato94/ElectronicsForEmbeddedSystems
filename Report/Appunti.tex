...
\fancyhf{} \fancyhead[RO, LE]{\bfseries \thepage}
 \fancyhead[RE, LO]{\includegraphics[scale=0.03]{Immagini/262}\bfseries}
...
\include{Capitoli/02} % Analog to digital conversion
\include{Capitoli/03} % Peripheral programming
\include{Capitoli/04} % Power management
\include{Capitoli/05} % Programmable logic device
\include{Capitoli/06} % Interconnection protocol
